...
#ifdef NUNCHUK_DEBUG
    mySerial.print("Ident: "); // 0xA4200000 for Nunchuck, 0xA4200101 for Classic, 0xA4200402 for Balance
...
static void nunchuk_print() {
    ...
    mySerial.print(buf);
#else
    mySerial.print(nunchuk_joystickX(), DEC);
    mySerial.print(",");
    mySerial.print(nunchuk_joystickY(), DEC);
    mySerial.print(",");
    mySerial.print(nunchuk_accelX(), DEC);
    mySerial.print(",");
    mySerial.print(nunchuk_accelY(), DEC);
    mySerial.print(",");
    mySerial.print(nunchuk_accelZ(), DEC);
    mySerial.print(",");
    mySerial.print(nunchuk_buttonZ(), DEC);
    mySerial.print(",");
    mySerial.print(nunchuk_buttonC(), DEC);
    mySerial.print("\n");
#endif
}
